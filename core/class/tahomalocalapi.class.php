...
public static function deamon_start() {
  ...
  $cmd .= ' --tahomaSession "' . trim(str_replace('"', '\"', json_encode(config::byKey('tahomalocalapi_session',  __CLASS__)))) . '"'; // TahomaSession
  
  
  log::add(__CLASS__, 'info', 'Lancement démon');
  log::add(__CLASS__, 'info', $cmd);
  log::add(__CLASS__,'info',json_encode(config::byKey('tahomalocalapi_session',  __CLASS__)));
